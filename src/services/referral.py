...
async def create_referral(session: AsyncSession, referrer_id: int, referred_id: int) -> bool:
    ...
    try:
        ...
        publish("referral.created", {"referrer_id": referrer_id, "referred_id": referred_id})
        return True
